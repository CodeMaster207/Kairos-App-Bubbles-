...
| Reward Centre (Postponed)               | Provides additional motivation through rewards, but it is not essential to demonstrating the core workload-management concept.                                                                           |
| Sleep Tracking (Postponed)              | Relevant to overall well-being but outside the priority scope of the MVP.                                                                                                                                |
| Pomodoro Timer (Deprioritised)          | Useful for focus management but does not directly address the primary problem of workload capacity.                                                                                                      |
| Focus Tunnel (Deprioritised)            | Considered useful for reducing distractions but was removed from the core scope to maintain a focused MVP.                                                                                               |
...
4. Implement task bubbles.
    
5. Develop basic workload scoring and capacity analysis.
    
6. Implement workload visualisation.
    
7. Integrate behaviour-based recommendations.
    
8. Implement basic recovery suggestions.
    
9. Connect the frontend, backend, database, and AI service.
    
10. Test and refine the primary user flow.


### 5.4: (Extra) Features Outside the Initial MVP
The following features will be postponed if they affect the feasibility of the core system:
- Sleep tracking
